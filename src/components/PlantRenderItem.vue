    ...
    <div :class="'plant-item ' + typeClass">
      ...
      <div class="plant-item__main" v-if="moisture">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="plant" viewBox="0 0 32 32">
          <ellipse v-if="moisture > 39" cx="18" cy="14.5" fill="green" class="plant__leaf-1" rx="1.5" ry="2.5" transform="matrix(0.5,0.9,-0.9,0.5,23,-10.2)"/>
          <ellipse v-if="moisture > 44" cx="24.5" cy="7" fill="green" class="plant__leaf-2" rx="2.5" ry="4" transform="matrix(0.5,-0.9,0.9,0.5,-6.6,26.4)"/>
          <ellipse v-if="moisture > 54" cx="9.8" cy="7.8" fill="green" class="plant__leaf-3" rx="2.5" ry="4.3" transform="matrix(0.9,0.4,-0.4,0.9,13,-6.2)"/>
          <g class="plant__pot">
              <rect v-if="moisture > 34" width="15" height="3" x="8.5" y="17.5" fill="brown"/>
              <rect v-if="moisture > 29" width="12" height="5.5" x="10" y="20.5" fill="brown"/>
              <rect v-if="moisture > 24" width="11" height="6" x="10.5" y="25.5" fill="brown"/>
          </g>
